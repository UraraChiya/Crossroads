...
public class CRConfig{
	...
	//	public static ModConfigSpec.BooleanValue genCopperOre;
	public static ModConfigSpec.BooleanValue genTinOre;
	public static ModConfigSpec.BooleanValue genRubyOre;
	public static ModConfigSpec.BooleanValue genVoidOre;
	//	public static ModConfigSpec.DoubleValue rubyRarity;
	public static ModConfigSpec.ConfigValue<List<? extends String>> processableOres;
	...
	public static ModConfigSpec.BooleanValue beamPowerCollision;
	public static ModConfigSpec.IntValue electPerJoule;
	public static ModConfigSpec.BooleanValue allowHellfire;
	public static ModConfigSpec.IntValue voltusValue;
	public static ModConfigSpec.IntValue atmosEffect;
	public static ModConfigSpec.BooleanValue atmosLightningHorsemen;
	public static ModConfigSpec.IntValue atmosCap;
	public static ModConfigSpec.BooleanValue chargeSpawnLightning;
	public static ModConfigSpec.BooleanValue allowOverflow;
	public static ModConfigSpec.BooleanValue cccRequireTime;
	public static ModConfigSpec.DoubleValue rotaryLoss;
	public static ModConfigSpec.IntValue rotaryLossMode;
	public static ModConfigSpec.DoubleValue crystalAxisMult;
	public static ModConfigSpec.IntValue steamWorth;
	public static ModConfigSpec.IntValue jouleWorth;
	public static ModConfigSpec.DoubleValue stirlingSpeedLimit;
	public static ModConfigSpec.DoubleValue stirlingConversion;
	public static ModConfigSpec.IntValue fePerCharge;
	public static ModConfigSpec.IntValue stampMillDamping;
	public static ModConfigSpec.BooleanValue phelEffect;
	...
	public static ModConfigSpec.IntValue recallTimeLimit;
	public static ModConfigSpec.BooleanValue hardGateway;
	public static ModConfigSpec.IntValue growMultiplier;
	public static ModConfigSpec.BooleanValue windingDestroy;
	public static ModConfigSpec.DoubleValue springGunCap;
	...
	public static ModConfigSpec.IntValue lodestoneDynamo;
	public static ModConfigSpec.IntValue fatPerValue;
	public static ModConfigSpec.IntValue mbPerIngot;
	public static ModConfigSpec.DoubleValue hellTemperature;
	public static ModConfigSpec.IntValue fireboxCap;
	public static ModConfigSpec.BooleanValue beamSounds;
	public static ModConfigSpec.BooleanValue electricSounds;
	public static ModConfigSpec.BooleanValue fluxSounds;
	public static ModConfigSpec.IntValue effectPacketDistance;
	public static ModConfigSpec.IntValue beaconHarnessPower;
	public static ModConfigSpec.BooleanValue technoArmorReinforce;
	public static ModConfigSpec.IntValue technoArmorCost;
	//	public static ModConfigSpec.BooleanValue beamDamageAbsolute;
	public static ModConfigSpec.BooleanValue beaconHarnessLoadSafety;
	public static ModConfigSpec.IntValue fluxNodeGain;
	public static ModConfigSpec.BooleanValue riftSpawnDrops;
	public static ModConfigSpec.DoubleValue enviroBootDepth;
	public static ModConfigSpec.IntValue enviroBootFrostWalk;
	...
	public static ModConfigSpec.IntValue beamHeatMult;
	public static ModConfigSpec.IntValue fireboxFuelMult;
	public static ModConfigSpec.DoubleValue solarRate;
	public static ModConfigSpec.DoubleValue medicinalMushroomSpread;
	public static ModConfigSpec.BooleanValue beamTransparent;
	public static ModConfigSpec.BooleanValue readoutChat;
	public static ModConfigSpec.BooleanValue permanentPotionParticles;
...
//		retrogen = serverBuilder.comment("Retrogen Key", "Changing this value will cause retrogen. Leaving it blank disables retrogen", "Turn this off when you are done!").define("retrogen", "");
		...
		solarRate = serverBuilder.comment("The rate at which the Solar Heater makes heat, in deg/t").defineInRange("solar_rate", 8.0, 0, 100);
		serverBuilder.pop();
...
//		beamDamageAbsolute = serverBuilder.comment("Whether void and void-potential (death) beams do absolute damage", "Absolute damage ignores potion effects and enchantments").define("beam_damage_absolute", false);
		...
		cloningBlacklist = serverBuilder.comment("Specify entities which can not be cloned. Players can never be cloned", "Format of 'domain:entity_id', ex. minecraft:pig").defineList("cloning_blacklist", Lists.newArrayList("minecraft:wither", "minecraft:ender_dragon"), () -> "minecraft:wither", (Object entry) -> entry instanceof String);
